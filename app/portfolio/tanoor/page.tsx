...
import tanoor from '@/public/image/tanoor.jpg'
    ...
    return (
        <div className='bg-zinc-900 p-5 md:px-10 md:rounded-lg rounded-br-lg rounded-bl-lg h-110 overflow-auto'>
            <div className='relative border-b-1 border-neutral-800 pb-5'>
                <h1 className='font-bold text-white text-xl pr-4'>تنور</h1>
                <span className='p-4.5 rounded-full circle-gra absolute top-0'></span>
            </div>

            <div>
                <Image src={tanoor} alt='tanor' className='rounded-lg' />
            </div>

            <div className='py-4'>
                <p className='text-slate-300 font-thin text-sm text-justify leading-6.5'>
                حالا میتونید آنلاین غذا سفارش بدید! 
                    <br />
                    ویژگی های تنور :
                </p>
                <ul className='mt-3 list-disc mr-4 text-slate-300 font-thin text-sm'>
                    ...
                    <li>دریافت امتیاز بعد از هر خرید</li>
                    <li>دریافت کد تخفیف با رسیدن به حد مشخص شده امتیازات</li>
                    <li>ثبت و سفارش غذا</li>
                </ul>
            ...
            <div>
                <a href='https://tanor-seven.vercel.app/' target="_blank" rel="noopener noreferrer">
